...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            @else
            <a href="{{ route('vendor.loginForm') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Log
                in</a>
            <a href="{{ route('vendor.registrationForm') }}"
